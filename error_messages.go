...
const (
	...
	RSL00008 string = "There is no file on path %s ready for client CommonName %d. Client sent away."
	...
	RSL00010 string = "There is no S3 object %s ready for client CommonName %d. Client sent away."
